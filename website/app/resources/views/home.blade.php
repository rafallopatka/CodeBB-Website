                ...
                <div class="features-bg">
                    <div class="container">
                        ...
                        <div class="row margin-bottom-30">
                            ...
                            <div class="col-md-3">
                                <div class="features">
                                    <img class="img-thumbnail rounded float-left" src="assets/meetings/programming-min.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="features">
                        ...
                        <div class="row margin-bottom-70">
                            ...
                            <div class="col-md-3">
                                <div class="features">
                                    <img class="img-thumbnail rounded float-left" src="assets/meetings/rxlogo-min.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="features">
