...
<section id="cookies">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="heading">
                    <h2>Polityka <strong>Cookies</strong></h2>
                </div>
...
<ul>
	<li><p><strong>Serwis</strong> - serwis internetowy działający pod adresem <span id="serwis"><span class="colored">codebb.pl</span></span></p></li>
    <li><p><strong>Serwis zewnętrzny</strong> - serwis internetowe partnerów, usługodawców lub usługobiorców Administratora</p></li>
    <li><p><strong>Administrator</strong> - serwis <span class="colored">codebb.pl</span>, świadczący usługi drogą elektroniczną oraz przechowujący i uzyskujący dostęp do informacji w urządzeniach Użytkownika</p></li>
...
<ul>
    ...
    <li><p><strong>Cookies sesyjne</strong> - pliki zamieszczane i odczytywane z Urządzenia Użytkownika przez Serwis <span id="sz1" style="display: inline;">lub Serwisy zewnętrzne</span> podczas jednej sesji danego Urządzenia. Po zakończeniu sesji pliki są usuwane z Urządzenia Użytkownika.</p></li>
...
<ul id="zewnetrzne"><li><p><strong><span class="colored">Google Analytics</span></strong></p></li><li><p><strong><span class="colored">Google AdSense</span></strong></p></li><li><p><strong>Google AdWords</strong></p></li> <li><p><strong><span class="colored">Google+</span></strong></p></li><li><p><strong><span class="colored">Facebook</span></strong></p></li><li><p><strong><span class="colored">Twitter</span></strong></p></li><li><p><strong><span class="colored">Youtube</span></strong></p></li><li><p><strong><span class="colored">Google reCAPTCHA</span></strong></p></li></ul>
